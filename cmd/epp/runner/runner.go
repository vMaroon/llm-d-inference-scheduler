...
import (
	...
	"github.com/llm-d/llm-d-router/pkg/epp/framework/plugins/requestcontrol/dataproducer/sessionprefix"
...
func (r *Runner) registerInTreePlugins() {
	...
	fwkplugin.Register(sessionprefix.ProducerType, sessionprefix.Factory)
